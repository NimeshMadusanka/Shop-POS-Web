          ...
          <Card sx={{ p: 3 }}>
            ...
            >
              <RHFTextField
                ...
                InputProps={{
                  style: {
                    fontSize: '23px',      // Input text size
                    height: '70px',        // Input box height
                  },
                }}
                InputLabelProps={{
                  style: {
                    fontSize: '21px',      // Label text size
                  },
                }}
              />
    ...
    <Controller
      ...
      render={({ field }) => (
        <Autocomplete
          ...
          renderInput={(params) => <TextField {...params} label="Select Product"  InputProps={{
    style: {
      fontSize: '23px',      // Input text size
      height: '70px',        // Input box height
    },
...
<Grid container spacing={3} alignItems="center" mt={2}>
  ...
  control={
    <Checkbox
      ...
      checked={field.value}
      sx={{
        width: 28,          // Checkbox size
        height: 28,
        '& .MuiSvgIcon-root': {
          fontSize: 28,     // Tick size
        },
      }}
    />
  }
...
/>
 ...
 <Box display="flex" flexDirection="column" gap={2}>
                    <TextField 
 required name="commissionAmount" label="commission Amount"  InputProps={{
    style: {
      fontSize: '20px',      // Input text size
      height: '55px',        // Input box height
    },
  }}
  InputLabelProps={{
    style: {
...
<Grid container spacing={3} sx={{ mt: 2 }}>
  ...
  sx={{
    ...
    padding: '12px 28px',    // Optional spacing
