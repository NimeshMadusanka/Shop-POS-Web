...
const getColorByName = (name: string) => {
  ...
  if (['F', 'G', 'T', 'I', 'J'].includes(getCharAtName(name))) return 'success';
  if (['K', 'D', 'Y', 'B', 'O'].includes(getCharAtName(name))) return 'success';
  if (['P', 'E', 'R', 'S', 'U'].includes(getCharAtName(name))) return 'success';
  if (['V', 'W', 'X', 'M', 'Z'].includes(getCharAtName(name))) return 'success';
  return 'default';
};
