...
const vi = {
  outlet_a: 'Ahangama',
  outlet_b: 'Arugam Bay',
  outlet_required: 'Can chon chi nhanh',
  outlet_scope_violation: 'Khong duoc phep thao tac khac chi nhanh',
  combined_view: 'Che do tong hop',
  viewing_outlet: 'Dang xem chi nhanh',
  demo: {
    title: `Vietnamese`,
