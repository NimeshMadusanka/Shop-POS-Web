...
const fr = {
  outlet_a: 'Ahangama',
  outlet_b: 'Arugam Bay',
  outlet_required: "Le point de vente est obligatoire",
  outlet_scope_violation: "L'action inter-point de vente n'est pas autorisee",
  combined_view: 'Vue combinee',
  viewing_outlet: 'Affichage point de vente',
  demo: {
    title: `France`,
